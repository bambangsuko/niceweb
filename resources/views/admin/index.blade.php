...
<div class="container px-6 mx-auto grid">
    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2">
        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <canvas id="pie" width="643" height="321" style="display: block; height: 214px; width: 429px;" class="chartjs-render-monitor"></canvas>
        ...
        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <canvas id="line" width="643" height="321" style="display: block; height: 214px; width: 429px;" class="chartjs-render-monitor"></canvas>
            <div class="flex justify-center mt-4 space-x-3 text-sm text-gray-600 dark:text-gray-400">
                <!-- Chart legend -->
                <div class="flex items-center">
                    <span class="inline-block w-3 h-3 mr-1 bg-teal-600 rounded-full"></span>
